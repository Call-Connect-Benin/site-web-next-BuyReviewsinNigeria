...
export function TrendingUp(props: SvgProps) {
  return (
    <svg {...defaults} {...props}>
...
export function BarChart(props: SvgProps) {
  return (
    <svg {...defaults} {...props}>
...
export function Award(props: SvgProps) {
  return (
    <svg {...defaults} {...props}>
...
export function Sparkles(props: SvgProps) {
  return (
    <svg {...defaults} {...props}>
...
export function AlertTriangle(props: SvgProps) {
  return (
    <svg {...defaults} {...props}>
...
export function ExternalLink(props: SvgProps) {
  return (
    <svg {...defaults} {...props}>
