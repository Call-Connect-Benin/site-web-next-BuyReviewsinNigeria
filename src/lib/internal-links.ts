...
const SERVICE_LINKS: InternalLink[] = [
  ...
  { href: "/services/gmb-optimization/gmb-profile-creation/", label: "GMB Profile Creation", description: "Create your Google Business Profile" },
  { href: "/services/gmb-optimization/gmb-profile-deletion/", label: "GMB Profile Deletion", description: "Remove duplicate or unwanted GMB profiles" },
  { href: "/services/gmb-optimization/gmb-ownership-recovery/", label: "GMB Ownership Recovery", description: "Recover lost GMB profile access" },
